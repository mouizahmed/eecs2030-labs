...
class HospitalTest {
	...
	void test_00_01_01() {
		...
		//System.out.println(director.employeeIDs);
	...
	@Test
	void test_00_03_00() {
		PhysicianAdministrator admin1 = new PhysicianAdministrator("Elizabeth", "Smith", 53, "Female", "Lawrence Avenue East");
		admin1.setAdminSpecialtyType("Immunology");
		//System.out.println(admin1.employeeIDs);
	...
	void test_00_06_03() {
		...
		physician4.setSalary(4000);
		hospital.hirePhysician(physician1);
		//System.out.println(hospital.adminList.get(1).getName());
		//System.out.println(admin2.extractPhysician().size());
	...
	void test_00_08_23() {
		...
		physician4.setSpecialty("Neurology");
		physician4.setSalary(4000);
		hospital.hirePhysician(physician1); // 8 - 3 = 5 + 3 = 8
		hospital.hirePhysician(physician2); // 8 - 3 = 5 + 3 = 8
		hospital.hirePhysician(physician3); // 8 - 1 = 7 - 7 = 0
		hospital.hirePhysician(physician4); // 0 + 1 = 1
	...
	void test_00_10_12() {
		...
		assertEquals(3, physician4.extractValunterDetail().size(), "extractValunterDetail fail");
	}
	...
	void test_00_10_13() {
		...
		hospital.hirePhysician(physician3);
		System.out.println(hospital.physList.get(3).first);
		...
		//System.out.println(physician3.volL.size());
		//System.out.println(hospital.physList.get(2).volL.size());
		//System.out.println(hospital.physList.get(3).first);
		try {
			hospital.resignVolunteer(v0);
